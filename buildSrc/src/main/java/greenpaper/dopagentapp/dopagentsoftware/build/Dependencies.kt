...
object Dependencies {
    ...
    const val EPOXY_PAGING = "com.airbnb.android:epoxy-paging3:${DependenciesVersions.EPOXY}"
    ...
    const val ROOM_ANNOTATION = "androidx.room:room-compiler:${DependenciesVersions.ROOM}"
